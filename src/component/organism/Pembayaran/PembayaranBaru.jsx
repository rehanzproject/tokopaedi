    ...
    <>
      <main className="relative  transform overflow-hidden rounded-lg bg-white px-10 shadow-xl transition-all  h-screen sm:my-8 sm:w-full sm:max-w-xl sm:items-center">
        ...
        <div className="border-t-8 justify-between py-2 flex">
          ...
          <img
            src={state.radio.image}
            alt={state.radio.name}
            className="h-10 sm:w-20 lg:w-24 "
          />
        </div>
        ...
        <button
          onClick={handleBuy}
          className="inline-flex border-2 items-center my-4 justify-center rounded-md text-green-500 py-2 px-10 text-sm font-semibold shadow-sm sm:ml-3 sm:w-full"
        >
          Beli Lagi
        </button>
        ...
        <button
          ...
          className="inline-flex items-center my-4 justify-center rounded-md bg-green-500 py-2 px-10 text-sm font-semibold text-white shadow-sm  hover:bg-green-600 sm:ml-3 sm:w-full"
        >
          Anggap saja sudah Bayar
        </button>
      </main>
      <img
        src="https://rexdl.co.id/wp-content/uploads/2020/08/tokopedia3.png"
        alt=""
        className="absolute w-1/2 right-5 top-0 sm:bottom-0"
      />
    </>
  );
}
